...
public class DatabaseManager : MonoBehaviour
{
    ...
    public struct playerInfo
    {
        ...
        int bulletCount { get; set; }      // –Ω秨紆计秖
        float spreadAngle { get; set; }  // 床甮羆à (続ノ紆薄猵)
        float bulletSpeed { get; set; }    // 紆硉
        float bulletLifeTime { get; set; }    // 紆硉
        float bulletDamage { get; set; }    // 紆端甡
